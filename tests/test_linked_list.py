...
class TestLinkedList(unittest.TestCase):
    ...
    def test_split_equal_should_split_in_equal_parts(self) -> None:
        ...
        list2: LinkedList[int] = LinkedList(1, LinkedList(2, LinkedList(3, LinkedList(4, LinkedList(5, LinkedList(6))))))
    ...
    def test_dedupe_impl(self) -> None:
        ...
        list3: LinkedList[int] = LinkedList(1, LinkedList(2, LinkedList(2, LinkedList(1))))
        assert repr(LinkedList.dedupe(list3)) == '1-2-1'

    def test_reverse_impl(self) -> None:
        list1: LinkedList[int] = LinkedList(1, LinkedList(2, LinkedList(3, LinkedList(4))))
    ...
    def test_palindrome_should_return_true_for_palindroms(self) -> None:
        list1: LinkedList[int] = LinkedList(1, LinkedList(2, LinkedList(2, LinkedList(1))))
